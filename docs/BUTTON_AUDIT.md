...
| Auto Text | Message not editable; delay/repeat unused | Text editor, join delay, optional repeat/whisper and Send now |
...
| Colors | Six fixed presets only | RGBA editor with opacity and preview |
...
- [ ] CPS decay, timer actions/completion, camera PNG/notification, waypoint lifetime, Auto Text opt-in.
