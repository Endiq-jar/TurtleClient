...
/*        val image = com.mojang.blaze3d.platform.NativeImage.read(bytes.inputStream())
        val texture = net.minecraft.client.renderer.texture.DynamicTexture({ "Turtle cape" }, image)
...
/*        val image = net.minecraft.client.texture.NativeImage.read(bytes.inputStream())
        val texture = net.minecraft.client.texture.NativeImageBackedTexture({ "Turtle cape" }, image)
