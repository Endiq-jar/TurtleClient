...
//? if >=26.1 {
/*    public static void draw(PoseStack.Pose pose, VertexConsumer consumer, List<CapeMesh.Vertex> vertices, int light) {
*///?} else {
    public static void draw(MatrixStack.Entry pose, VertexConsumer consumer, List<CapeMesh.Vertex> vertices, int light) {
//?}
        for (CapeMesh.Vertex v : vertices) {
